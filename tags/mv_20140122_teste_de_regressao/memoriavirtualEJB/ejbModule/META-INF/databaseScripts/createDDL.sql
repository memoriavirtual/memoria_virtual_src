...
CREATE TABLE AUTORIA (TIPOAUTORIA INTEGER NOT NULL, BEMPATRIMONIAL BIGINT NOT NULL, AUTOR_ID BIGINT NOT NULL, PRIMARY KEY (TIPOAUTORIA, BEMPATRIMONIAL, AUTOR_ID));
