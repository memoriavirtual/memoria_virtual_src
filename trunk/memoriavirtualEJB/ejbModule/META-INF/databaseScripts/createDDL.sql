...
CREATE TABLE INSTITUICAO (ID BIGINT NOT NULL, ADMINISTRADORPROPRIEDADE VARCHAR(255), ALTITUDE VARCHAR(255), CAIXAPOSTAL VARCHAR(255), CEP VARCHAR(255), CIDADE VARCHAR(255), EMAIL VARCHAR(255), ENDERECO VARCHAR(255), ESTADO VARCHAR(255), IDENTIFICACAOPROPRIETARIO VARCHAR(255), LATITUDE VARCHAR(255), LOCALIDADE VARCHAR(255), LONGITUDE VARCHAR(255), NOME VARCHAR(255), PAIS VARCHAR(255), PROTECAOEXISTENTE VARCHAR(255), TELEFONE VARCHAR(255), TIPOPROPRIEDADE VARCHAR(255), URL VARCHAR(255), VALIDADE BOOLEAN, PRIMARY KEY (ID));
