...
CREATE TABLE ITEMAUDITORIA (DATA DATE NOT NULL, ATRIBUTOSIGNIFICATIVO VARCHAR(255), NOTAS VARCHAR(255), TIPOACAO VARCHAR(255), AUTORACAO_ID VARCHAR(255), PRIMARY KEY (DATA))
