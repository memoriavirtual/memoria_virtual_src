...
CREATE TABLE AUTOR (ID BIGINT NOT NULL, ATIVIDADE VARCHAR(255), CODINOME VARCHAR(255), NASCIMENTO DATE, NOME VARCHAR(255), OBITO DATE, SOBRENOME VARCHAR(255), TIPOAUTORIA VARCHAR(255), PRIMARY KEY (ID));
