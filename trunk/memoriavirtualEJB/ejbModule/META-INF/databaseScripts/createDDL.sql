...
CREATE TABLE BEMPATRIMONIAL_ASSUNTOS (ASSUNTOS_ID BIGINT, ASSUNTOS VARCHAR(255));
...
ALTER TABLE BEMPATRIMONIAL_ASSUNTOS ADD CONSTRAINT FK_BEMPATRIMONIAL_ASSUNTOS_ASSUNTOS_ID FOREIGN KEY (ASSUNTOS_ID) REFERENCES BEMPATRIMONIAL (ID);
