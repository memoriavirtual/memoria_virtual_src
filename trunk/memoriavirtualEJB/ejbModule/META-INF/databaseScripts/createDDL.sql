...
CREATE TABLE BEMARQUEOLOGICO (ID BIGINT NOT NULL, AGUAPROXIMO VARCHAR(255), ALTURA FLOAT, AREATOTAL FLOAT, COMPRIMENTO FLOAT, CONDICAOTOPOGRAFICA VARCHAR(255), EXPOSICAO VARCHAR(255), LARGURA FLOAT, NOTAS VARCHAR(255), OUTROS VARCHAR(255), POSSUIVEGETACAO VARCHAR(255), PROFUNDIDADE FLOAT, SITIODAPAISAGEM VARCHAR(255), USOATUAL VARCHAR(255), PRIMARY KEY (ID));
...
CREATE TABLE BEMARQUITETONICO (ID BIGINT NOT NULL, ALCOVA BOOLEAN, ALTURAFACHFRONTAL FLOAT, ALTURAFACHPOSTERIOR FLOAT, ALTURATOTAL FLOAT, AREATOTAL FLOAT, CONDICAOTOPOGRAFIA VARCHAR(255), LARGURA FLOAT, NUMERODEAMBIENTES INTEGER, NUMERODEPAVIMENTOS INTEGER, OUTROS VARCHAR(255), PEDIREITOTERREO FLOAT, PORAO BOOLEAN, PROFUNDIDADE FLOAT, SOTAO BOOLEAN, TIPOPEDIREITO VARCHAR(255), USO VARCHAR(255), PRIMARY KEY (ID));
