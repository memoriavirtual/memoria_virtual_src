...
CREATE TABLE BEMPATRIMONIAL (ID BIGINT NOT NULL, AGUAPROXIMA VARCHAR(255), ALCOVA BOOLEAN, ALTURA VARCHAR(255), ALTURACUMEEIRA VARCHAR(255), ALTURAFACHADAFRONTAL VARCHAR(255), ALTURAFACHADAPOSTERIOR VARCHAR(255), ALTURATOTAL VARCHAR(255), AREATOTAL VARCHAR(255), CARACTERISTICASAMBIENTAIS TEXT, CARACTERISTICASFISICASTECNICASEXECUTIVAS TEXT, COLECAO VARCHAR(255), COMPLEMENTO TEXT, COMPRIMENTO VARCHAR(255), CONDICAOTOPOGRAFICA VARCHAR(255), CONTEUDO TEXT, DIMENSOESQUANTIFICACOES VARCHAR(255), EXPOSICAO INTEGER, EXTERNO BOOLEAN, IDMIDIA VARCHAR(255), LARGURA VARCHAR(255), LATITUDE VARCHAR(255), LOCALIZACAOFISICA VARCHAR(255), LONGITUDE VARCHAR(255), MEIOACESSO TEXT, MEIOANTROPICO TEXT, NOTAS TEXT, NUMEROAMBIENTES INTEGER, NUMEROPAVIMENTOS INTEGER, NUMEROREGISTRO VARCHAR(255), OUTROS TEXT, PEDIREITOTERREO VARCHAR(255), PEDIREITOTIPO VARCHAR(255), PORAO BOOLEAN, PROFUNDIDADE VARCHAR(255), REVISAO BOOLEAN, SITIOPAISAGEM VARCHAR(255), SOTAO BOOLEAN, TIPOBEMPATRIMONIAL VARCHAR(255), TITULOPRINCIPAL VARCHAR(255), USO VARCHAR(255), USOATUAL VARCHAR(255), VEGETACAO VARCHAR(255), ESTADOCONSERVACAO INTEGER, ESTADOPRESERVACAO INTEGER, NOTASESTADOCONSERVACAO TEXT, CONDICOESACESSO INTEGER, CONDICOESREPRODUCAO INTEGER, DATARETORNO VARCHAR(255), DISPONIBILIDADE INTEGER, LEGISLACAO VARCHAR(255), NOTASUSOAPROVEITAMENTO TEXT, PROTECAO INTEGER, PROTETORAINSTITUICAO VARCHAR(255), DADOSDOCTRANSACAO TEXT, DATAAQUISICAO VARCHAR(255), HISTORICO TEXT, INSTRUMENTOPESQUISA TEXT, PRIMEIROPROPRIETARIO VARCHAR(255), TIPOAQUISICAO INTEGER, VALORVENALTRANSACAO VARCHAR(255), ANO VARCHAR(255), EDICAO VARCHAR(255), LOCAL VARCHAR(255), OUTRASRESPONSABILIDADES TEXT, INSTITUICAO_ID BIGINT, CONTAINERMULTIMIDIA_ID BIGINT, PRIMARY KEY (ID));
...
CREATE TABLE BEMPATRIMONIAL_FONTESINFORMACAO (BEMPATRIMONIAL_ID BIGINT, FONTESINFORMACAO TEXT);
CREATE TABLE BEMPATRIMONIAL_ASSUNTO (BEMPATRIMONIAL_ID BIGINT NOT NULL, ASSUNTO_ID VARCHAR(255) NOT NULL, PRIMARY KEY (BEMPATRIMONIAL_ID, ASSUNTO_ID));
...
CREATE TABLE BEMPATRIMONIAL_DESCRITOR (BEMPATRIMONIAL_ID BIGINT NOT NULL, DESCRITOR_ID VARCHAR(255) NOT NULL, PRIMARY KEY (BEMPATRIMONIAL_ID, DESCRITOR_ID));
