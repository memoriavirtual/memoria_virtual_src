CREATE TABLE MULTIMIDIA (ID BIGINT NOT NULL, CONTENT BYTEA, CONTENTTYPE VARCHAR(255), DESCRICAO VARCHAR(255), NOME VARCHAR(255), CONTAINERMULTIMIDIA_ID BIGINT, PRIMARY KEY (ID));
...
CREATE TABLE TITULO (ID BIGINT NOT NULL, TIPO VARCHAR(255), VALOR VARCHAR(255), BEMPATRIMONIAL_ID BIGINT, PRIMARY KEY (ID));
...
ALTER TABLE TITULO ADD CONSTRAINT FK_TITULO_BEMPATRIMONIAL_ID FOREIGN KEY (BEMPATRIMONIAL_ID) REFERENCES BEMPATRIMONIAL (ID);
...
CREATE SEQUENCE TITULO_ID INCREMENT BY 50 START WITH 50;
