...
CREATE TABLE USUARIO (ID VARCHAR(255) NOT NULL, ADMINISTRADOR BOOLEAN, ATIVO BOOLEAN, EMAIL VARCHAR(255) UNIQUE, NOMECOMPLETO VARCHAR(255),TELEFONE VARCHAR(255), SENHA VARCHAR(255), VALIDADE DATE, PRIMARY KEY (ID));
...
/* Usuario admin padrão para o desenvolvimento do sistema:
ID:mvirtual
Email:mvirtual@usp.br
senha:mvirtual
*/
INSERT INTO USUARIO values( 'mvirtual', true, true, 'mvirtual@usp.br','Memória Virtual','(16)7777-7777',
