...
public class ObterNovaSenha implements ObterNovaSenhaRemote {
	...
	public void obterNovaSenha(String email) throws ModeloException {
		...
		if (usuario != null) {
			...
			try {
				String assunto = "Recupera��o de senha do Memoria Virtual";
				String mensagem = "Voc� foi solicitou uma nova senha do Memoria Virtual.  "
			...
			throw new ModeloException("Email n�o encontrado!");
	}
	...
	public void cadastrarNovaSenha(String email, String token, String novaSenha) throws ModeloException {
		...
		if (usuario != null) {
			...
			throw new ModeloException("Erro ao processar sua solicita��o.");
	}
	...
	private Usuario recuperarUsuario(String email) throws ModeloException {
		...
		try {
			...
			throw new ModeloException("Email n�o cadastrado!");
		}
		return usuario;
	}
