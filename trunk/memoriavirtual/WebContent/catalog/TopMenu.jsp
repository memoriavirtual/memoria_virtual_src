<%-- 
    Document   : TopMenu
    Created on : 26.08.2009, 02:11:21
    Author     : Fabricio
--%>

<ul>
    <li><a href="<s:url namespace="/institution" action="RenderInstitutionMainPage" />">Instituição</a></li>
    <li><a href="<s:url namespace="/user" action="RenderUserMainPage" />">Usuário</a></li>
