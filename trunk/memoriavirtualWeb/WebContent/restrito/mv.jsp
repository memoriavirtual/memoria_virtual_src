...
<body>
	<f:view>
		<div id="recipiente">
					...
					<ul>
						...
						<li class="bempatrimonial"><a href="bempatrimonial.html">Bem
								Patrimonial<script>
									...
									$('.bempatrimonial li a').corner("top 1px");
								</script> </a>
							<ul>
						...
						<li class="usuario"><a href="usuario.html">Administra&ccedil;&atilde;o<script>
							$('.usuario a').corner("top");
							$('.usuario li a').corner("top 1px");
						</script> </a>
							<ul>
						...
						<li class="instituicao"><a href="instituicao.html">Institui&ccedil;&atilde;o<script>
							...
							$('.instituicao li a').corner("top 1px");
						</script> </a>
							<ul>
			...
			<div id="conteudo">
				<div id="CaixaCorpo"></div>
				<!-- fim .CaixaCorpo -->
			</div>
			<!-- fim #conteudo -->
			<div id="rodape">Copyright &copy; 2009 LABES -
				Laborat&oacute;rio de Engenharia de Software - ICMC-USP</div>
			<!-- fim #rodape -->
		</div>
		<!-- fim #recipiente -->
	</f:view>
