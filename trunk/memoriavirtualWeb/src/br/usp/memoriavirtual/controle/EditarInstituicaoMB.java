...
public class EditarInstituicaoMB{
	...
	public List<SelectItem> getInstituicoesPermitidas() {
		...
		if (usuario.isAdministrador()) {
			...
			instituicoesUsuario = this.editarInstituicaoEJB.getInstituicoes(grupo, usuario);
		}
		for (Instituicao instituicao : instituicoesUsuario) {
			listaInstituicoes.add(new SelectItem(instituicao.getNome(), instituicao.getNome()));
		}
		return listaInstituicoes;
	}
	
	public String editarInstiuicao(){
		
		String resultado;
		//Checagem no servidor de completeza dos dados
		if((this.novoNome == null) || (this.novoEmail == null) || (this.novoLocalizacao == null) || (this.novoEndereco == null) || (this.novoCidade == null) || (this.novoEstado == null) || (this.novoCep == null) || (this.novoTelefone == null))
			return "Incompleto";
		
		resultado = this.editarInstituicaoEJB.editarInstituicao(this.instituicao.getNome(), this.novoNome, this.novoEmail, this.novoLocalizacao, this.novoEndereco, this.novoCidade, this.novoEstado, this.novoCep, this.novoTelefone);
		return resultado;
	...
	/**
	 * @param velhoNome the velhoNome to set
	 */
	...
	/**
	 * @param novoNome the novoNome to set
	 */
	...
	/**
	 * @param novoEmail the novoEmail to set
	 */
	...
	/**
	 * @param novoLocalizacao the novoLocalizacao to set
	 */
	...
	/**
	 * @param novoCidade the novoCidade to set
	 */
	...
	/**
	 * @param novoEstado the novoEstado to set
	 */
	...
	/**
	 * @param novoCep the novoCep to set
	 */
	...
	/**
	 * @param novoTelefone the novoTelefone to set
	 */
