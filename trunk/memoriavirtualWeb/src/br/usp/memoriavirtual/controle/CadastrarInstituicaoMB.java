...
/**
 * Mananged Bean respons√°vel pelo controle do cadatro de uma nova institui√ß√£o
 */
...
public class CadastrarInstituicaoMB {
	...
	public String cadastrarInstituicao() {
			if (this.validateNome() && this.validateLocalizacao() && this.validateCep() && this.validateTelefone()) {
				...
				//Como n„o È necessario a aprovaÁ„o de nenhum outro administrador
				//A validade do registro j· È setada como verdadeira.
				...
				// Testa se a instituiÁ„o foi gravada
	...
	/**
	 * Getter da localiza√ß√£o
	 * 
	 * @return (String) Localiza√ß√£o da instituicao
	 */
	...
	/**
	 * Getter do estado(unidade da federa√ß√£o)
	 * 
	...
	/**
	 * Setter do nome da institui√ß√£o
	 */
	...
	/**
	 * Setter da localiza√ß√£o da instituicao
	 */
